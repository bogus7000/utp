...
public class HumanResourcesStatisticsTest {
	...
	public void payroll() {
		//
		// Assert.assertEquals(<expected>, HumanResourcesStatistics.payroll(_allEmployees));
	}

	@Test
	public void subordinatesPayroll() {
		//
		// Assert.assertArrayEquals(<expected>, HumanResourcesStatistics.subordinatesPayroll(null);
	}
